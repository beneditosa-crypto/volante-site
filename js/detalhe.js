...
import {import { db } from "./firebase.js";
...
async function carregarDetalhe() {
  ...
  try {
    ...
    const colecaoFallback =
      tipoParam === "evento"
        ? "anuncios"
        : "eventos";

    let itemSnap =
      await getDoc(doc(db, colecaoPrincipal, id));
    ...
    if (!itemSnap.exists()) {
      itemSnap =
        await getDoc(doc(db, colecaoFallback, id));
      ...
      <div class="painel">
        ...
        <div class="compartilhar">
          <div class="bloco">
            ...
            <p>
              Envie este ${ehEvento ? "evento" : "anúncio"} para amigos e grupos.
            </p>
